...
export default function CampusNavigator() {
  ...
  const startLiveNavigation = async () => {
    if (selectedBuilding && currentRoute) {
      try {
        ...
        alert(
          "Failed to start navigation. Please ensure location access is enabled."
        );
      }
    }
  };
  ...
  const startLiveNavigationFromCurrentLocation = async () => {
    if (selectedBuilding && currentLocation) {
      try {
        ...
        console.error(
          "Failed to start navigation from current location:",
          error
        );
        alert(
          "Failed to start navigation. Please ensure location access is enabled and try again."
        );
      }
    }
  };
  ...
  const startLocationTracking = async () => {
    try {
      ...
      alert(
        "Failed to start location tracking. Please ensure location access is enabled."
      );
      setPendingLocationSelection(false);
    }
  };
      ...
      <div className="min-h-screen living-bg particle-bg flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Loading Manipal University Jaipur campus...
          </p>
        </div>
      </div>
    );
        ...
        <div className="container mx-auto px-4 py-4 z-50 sticky top-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-700 via-blue-400 to-cyan-400 bg-clip-text text-transparent animate-gradient">
          ...
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card className="shadow-crystal-medium hover:shadow-crystal-strong">
                <CardHeader>
                  <CardTitle className="text-lg neon-text-living">
                    Campus Areas
                  </CardTitle>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {navigationFrom.id === -1 && (
                            <Badge
                              variant="secondary"
                              className="text-xs shadow-crystal"
                            >
                              Live GPS
                            </Badge>
                          )}
                          ...
                          <div className="max-h-32 overflow-y-auto space-y-1">
                            {currentRoute.instructions
                              ...
                              .map((instruction, index) => (
                                <div
                                  key={index}
                                  className="text-xs p-2 bg-gray-50/20 backdrop-blur-living rounded shadow-crystal"
                                >
                            ...
                            {currentRoute.instructions.length > 5 && (
                              <p className="text-xs text-black-500 text-center">
                                +{currentRoute.instructions.length - 5} more
                                steps
                              </p>
                            )}
                          </div>
                  ...
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 neon-text-living">
                      {(() => {
                        const Icon =
                          categoryIcons[
                            selectedBuilding.category as keyof typeof categoryIcons
                          ];
                  ...
                  <CardContent className="space-y-4">
                    <Badge
                      style={{
                        backgroundColor:
                          categoryColors[
                            selectedBuilding.category as keyof typeof categoryColors
                          ],
                      }}
                      className="text-white shadow-crystal glow-living-primary"
                    >
                    ...
                    {selectedBuilding.phone && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <a
                          href={`tel:${selectedBuilding.phone}`}
                    ...
                    {selectedBuilding.services &&
                      selectedBuilding.services.length > 0 && (
                        <div>
                    ...
                    <div className="space-y-2">
                      <Button
                        ...
                        className="w-full shadow-crystal-medium hover:shadow-crystal-strong"
                      >
                      ...
                      {currentLocation && (
                        <Button
                          ...
                          variant="secondary"
                          className="w-full shadow-crystal hover:shadow-crystal-medium"
                        >
              ...
              {currentLocation && !selectedBuilding && (
                <Card className="shadow-crystal-medium hover:shadow-crystal-strong glow-living-primary">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Use your current location for navigation
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground text-center">
                      Select a destination building to navigate from your
                      current location
                    </p>
                  </CardContent>
                </Card>
            ...
            <div className="lg:col-span-3">
              <Card className="h-[600px] shadow-crystal-medium hover:shadow-crystal-strong">
                <CardHeader>
                  <CardTitle className="neon-text-living">
                    Manipal University Jaipur Campus Map
                  </CardTitle>
                  <CardDescription>
                    Click on buildings to view details and plan your route
                    across campus
                  </CardDescription>
                </CardHeader>
                    ...
                    {categories.map((category) => {
                      ...
                      return (
                        <div key={category} className="flex items-center gap-2">
                          <div
                            className="w-4 h-4 rounded-full shadow-crystal"
                            style={{
                              backgroundColor:
                                categoryColors[
